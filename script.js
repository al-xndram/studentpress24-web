...
function highlight_book(parent) {
  z += 1;
  parent.style.boxShadow = `0 0 80px 10px rgba(${boxshadow.r}, ${boxshadow.g}, ${boxshadow.b}, 0.2)`;
  parent.parentElement.style.zIndex = z;
}

function unhighlight_book(parent) {
  parent.style.boxShadow = `rgba(${boxshadow.r}, ${boxshadow.g}, ${boxshadow.b}, 0.1) 0px 0px 30px 20px`;
}
